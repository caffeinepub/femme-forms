  ...
  return (
    <div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url(/assets/generated/hero-paper-texture.dim_1920x1080.png)",
        }}
      >
        ...
        <div className="container relative py-24 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              Celebrating the beauty, sensuality, and grace of the feminine form
              through hand-drawn sketches. Each piece captures the essence of
              women's faces, bodies, and spirit with artistic elegance.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="shimmer-border shimmer-glow"
              >
      ...
      <section className="container py-16 md:py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Explore original sketches celebrating feminine beauty
          </p>
        </div>
